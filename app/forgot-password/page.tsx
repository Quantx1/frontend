...
import { Mail, ArrowLeft, CheckCircle, Loader2 } from '@/lib/icons'
  ...
  return (
    ...
    >
      <div className="animate-fade-in-up">
        <Link
          href="/login"
          className="mb-8 inline-flex items-center gap-2 text-sm text-d-text-secondary transition hover:text-primary"
        >
          <ArrowLeft className="h-4 w-4" />
          Back to Login
        </Link>

        <h2 className="mb-2 text-2xl font-bold tracking-tight text-d-text-primary">Reset Password</h2>
        <p className="mb-6 text-sm text-d-text-secondary">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="mb-2 block text-sm font-medium text-d-text-primary">
                Email Address
              </label>
