                ...
                <tbody className="divide-y divide-white/[0.04]">
                  {payments.map((payment) => (
                    <tr key={payment.id} className="hover:bg-white/[0.04] transition-colors">
                      ...
                      <td className="px-4 py-4 text-right text-d-text-muted text-xs">
                        {/* Refunds: handled via Razorpay dashboard only.
                            Locked rule (2026-04-19): no user-facing refund surface,
                            no admin refund tool. */}
                        —
                      </td>
                    </tr>
                  ))}
