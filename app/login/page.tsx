  ...
  return (
    <AuthLayout>
      <div className="animate-fade-in-up">
        <div className="mb-8">
          <h1 className="text-2xl font-bold tracking-tight text-d-text-primary">Welcome back</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          {/* Email */}
          <div>
            <label htmlFor="email" className="mb-2 block text-sm font-medium text-d-text-primary">
              Email Address
            </label>
          ...
          {/* Password */}
          <div>
            <label htmlFor="password" className="mb-2 block text-sm font-medium text-d-text-primary">
              Password
            </label>
            <div className="input-animated-wrapper relative">
              ...
              <button
                ...
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-d-text-muted transition-colors hover:text-d-text-primary"
              >
          ...
          <div className="flex items-center justify-between">
            <label className="flex cursor-pointer items-center gap-2">
              ...
              />
              <span className="text-sm text-d-text-secondary">Remember me</span>
            </label>
            <Link
