  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <aside className="absolute inset-y-0 left-0 flex w-72 max-w-[80vw] flex-col border-r border-line glass-chrome">
        <div className="flex h-14 shrink-0 items-center justify-between border-b border-line px-4">
          ...
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-full text-d-text-secondary transition-colors hover:bg-wrap-hover hover:text-d-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
          >
        ...
        <div className="shrink-0 px-3 pt-3">
          <Link
            href="/copilot"
            onClick={onClose}
            className="flex items-center justify-center gap-1.5 rounded-full border border-line bg-surface-2 px-3 py-2.5 text-[13px] font-medium text-d-text-secondary transition-colors hover:text-d-text-primary"
          >
        ...
        <div className="mt-auto shrink-0">
          <div className="flex items-center gap-1 border-t border-line px-3 py-2">
            <Link href="/inbox" onClick={onClose} aria-label="Notifications" className="flex h-10 flex-1 items-center justify-center gap-2 rounded-full text-d-text-secondary transition-colors hover:bg-wrap-hover hover:text-d-text-primary">
