...
import { ChevronDown, Gavel, Shield, TrendingUp, TrendingDown, Activity, FileText } from '@/lib/icons'
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-baseline gap-1.5">
          ...
          <span className="text-[11px] text-d-text-muted">
            conf <span className="numeric text-d-text-primary">{Math.round(confidence)}</span>
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-center justify-between gap-3 px-4 py-3 hover:bg-hover transition-colors"
      >
