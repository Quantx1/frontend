...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2.5 rounded-sm px-2.5 py-2 text-sm outline-none transition-colors duration-instant ease-out data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-[selected=true]:bg-surface-2 data-[selected=true]:text-d-text-primary text-d-text-secondary [&_svg]:pointer-events-none [&_svg]:shrink-0",
      className
    )}
    {...props}
  />
