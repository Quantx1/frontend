...
export default function PayoffDiagram({ legs, spotPrice, lotSize, label }: PayoffDiagramProps) {
  ...
  if (!data.length) {
    return (
      <div className="glass-card p-5 text-center">
        <p className="text-sm text-d-text-muted">No legs configured for payoff diagram</p>
      </div>
    )
  }
  ...
  return (
    <div className="glass-card p-5">
      <h3 className="text-sm font-semibold text-d-text-primary mb-1 flex items-center gap-2">
